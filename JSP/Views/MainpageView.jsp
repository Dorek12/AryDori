...
<head>
<meta charset="UTF-8">
<title>Elektronik günstig kaufen</title>
...
<body>
	...
	<jsp:useBean id="mainpage" class="Beans.MainpageBean" scope="session"></jsp:useBean>

	<jsp:getProperty property="headerAsHtml" name="framework" />
	<jsp:getProperty property="bodyForMainpage" name="mainpage" />
